...
export class ApplicationException extends Error {
  ...
  static useCaseError(operation: string, details: string): ApplicationException {
  ...
  static validationError(details: string): ApplicationException {
    return new ApplicationException(`Validation error: ${details}`, ErrorCode.VALIDATION_ERROR, 400);
  }
}
